...
function GetSKUAndGroups(searchText, thisDoc) {
  ...
  //AVMurach +    
   ...
   /* var stocksAnswer = " LEFT JOIN Document_Visit_SKUs VSKU ON VSKU.SKU = S.Id AND VSKU.Ref In " +
    ...
    var stocksAnswer = " LEFT JOIN USR_SKUQuestions VSKU ON VSKU.SKU = S.Id " + 
	" AND VSKU.Question IN (SELECT Id FROM Catalog_Question CQ WHERE CQ.Assignment=@assignment) ";
  ...
  //остатки в ТТ
    ...
    if (stock.EmptyRef()==true){
	    ...
	    query.Text = "SELECT DISTINCT S.Id, S.Description, PL.Price AS Price, S.CommonStock AS CommonStock " +
	    		...
	    		"substr('00' || CASE WHEN date(datetime('now','-7 day'), 'start of year') != date(datetime('now'), 'start of year') THEN CASE WHEN strftime('%W', date(datetime('now','-7 day'), 'start of year')) = '00' THEN CASE WHEN CAST(strftime('%W', date(datetime('now'), '-7 day')) as integer) = 52 OR CAST(strftime('%W', date(datetime('now'), '-7 day')) as integer) = 0 THEN 53 ELSE CAST(strftime('%W', date(datetime('now'), '-7 day')) as integer)+1 END ELSE CASE WHEN CAST(strftime('%W', date(datetime('now'), '-7 day')) as integer) = 53 OR CAST(strftime('%W', date(datetime('now'), '-7 day')) as integer) = 0 THEN 53 ELSE CAST(strftime('%W', date(datetime('now'), '-7 day')) as integer) END END ELSE CASE WHEN strftime('%W', date(datetime('now','-7 day'), 'start of year')) = '00' THEN CASE WHEN CAST(strftime('%W', date(datetime('now'), '-7 day')) as integer) = 52 OR CAST(strftime('%W', date(datetime('now'), '-7 day')) as integer) = 0 THEN 53 ELSE CAST(strftime('%W', date(datetime('now'), '-7 day')) as integer) END ELSE CASE WHEN CAST(strftime('%W', date(datetime('now'), '-7 day')) as integer) = 53 OR CAST(strftime('%W', date(datetime('now'), '-7 day')) as integer) = 0 THEN 53 ELSE CAST(strftime('%W', date(datetime('now'), '-7 day')) as integer) END END END, -2, 2) AS week1, " +
	    		"substr('00' || CASE WHEN date(datetime('now','-14 day'), 'start of year') != date(datetime('now'), 'start of year') THEN CASE WHEN strftime('%W', date(datetime('now','-14 day'), 'start of year')) = '00' THEN CASE WHEN CAST(strftime('%W', date(datetime('now'), '-14 day')) as integer) = 52 OR CAST(strftime('%W', date(datetime('now'), '-14 day')) as integer) = 0 THEN 53 ELSE CAST(strftime('%W', date(datetime('now'), '-14 day')) as integer)+1 END ELSE CASE WHEN CAST(strftime('%W', date(datetime('now'), '-14 day')) as integer) = 53 OR CAST(strftime('%W', date(datetime('now'), '-7 day')) as integer) = 0 THEN 53 ELSE CAST(strftime('%W', date(datetime('now'), '-14 day')) as integer) END END ELSE CASE WHEN strftime('%W', date(datetime('now','-14 day'), 'start of year')) = '00' THEN CASE WHEN CAST(strftime('%W', date(datetime('now'), '-14 day')) as integer) = 52 OR CAST(strftime('%W', date(datetime('now'), '-14 day')) as integer) = 0 THEN 53 ELSE CAST(strftime('%W', date(datetime('now'), '-14 day')) as integer) END ELSE CASE WHEN CAST(strftime('%W', date(datetime('now'), '-14 day')) as integer) = 53 OR CAST(strftime('%W', date(datetime('now'), '-14 day')) as integer) = 0 THEN 53 ELSE CAST(strftime('%W', date(datetime('now'), '-14 day')) as integer) END END END, -2, 2) AS week2, " +
	    		"substr('00' || CASE WHEN date(datetime('now','-21 day'), 'start of year') != date(datetime('now'), 'start of year') THEN CASE WHEN strftime('%W', date(datetime('now','-21 day'), 'start of year')) = '00' THEN CASE WHEN CAST(strftime('%W', date(datetime('now'), '-21 day')) as integer) = 52 OR CAST(strftime('%W', date(datetime('now'), '-21 day')) as integer) = 0 THEN 53 ELSE CAST(strftime('%W', date(datetime('now'), '-21 day')) as integer)+1 END ELSE CASE WHEN CAST(strftime('%W', date(datetime('now'), '-21 day')) as integer) = 53 OR CAST(strftime('%W', date(datetime('now'), '-21 day')) as integer) = 0 THEN 53 ELSE CAST(strftime('%W', date(datetime('now'), '-21 day')) as integer) END END ELSE CASE WHEN strftime('%W', date(datetime('now','-21 day'), 'start of year')) = '00' THEN CASE WHEN CAST(strftime('%W', date(datetime('now'), '-21 day')) as integer) = 52 OR CAST(strftime('%W', date(datetime('now'), '-21 day')) as integer) = 0 THEN 53 ELSE CAST(strftime('%W', date(datetime('now'), '-21 day')) as integer) END ELSE CASE WHEN CAST(strftime('%W', date(datetime('now'), '-21 day')) as integer) = 53 OR CAST(strftime('%W', date(datetime('now'), '-21 day')) as integer) = 0 THEN 53 ELSE CAST(strftime('%W', date(datetime('now'), '-21 day')) as integer) END END END, -2, 2) AS week3, " +
	    		"substr('00' || CASE WHEN date(datetime('now','-28 day'), 'start of year') != date(datetime('now'), 'start of year') THEN CASE WHEN strftime('%W', date(datetime('now','-28 day'), 'start of year')) = '00' THEN CASE WHEN CAST(strftime('%W', date(datetime('now'), '-28 day')) as integer) = 52 OR CAST(strftime('%W', date(datetime('now'), '-28 day')) as integer) = 0 THEN 53 ELSE CAST(strftime('%W', date(datetime('now'), '-28 day')) as integer)+1 END ELSE CASE WHEN CAST(strftime('%W', date(datetime('now'), '-28 day')) as integer) = 53 OR CAST(strftime('%W', date(datetime('now'), '-28 day')) as integer) = 0 THEN 53 ELSE CAST(strftime('%W', date(datetime('now'), '-28 day')) as integer) END END ELSE CASE WHEN strftime('%W', date(datetime('now','-28 day'), 'start of year')) = '00' THEN CASE WHEN CAST(strftime('%W', date(datetime('now'), '-28 day')) as integer) = 52 OR CAST(strftime('%W', date(datetime('now'), '-28 day')) as integer) = 0 THEN 53 ELSE CAST(strftime('%W', date(datetime('now'), '-28 day')) as integer) END ELSE CASE WHEN CAST(strftime('%W', date(datetime('now'), '-28 day')) as integer) = 53 OR CAST(strftime('%W', date(datetime('now'), '-28 day')) as integer) = 0 THEN 53 ELSE CAST(strftime('%W', date(datetime('now'), '-7 day')) as integer) END END END, -2, 2) AS week4, " +
